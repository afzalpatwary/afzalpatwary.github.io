...
if ($name == "") {
    ...
    $headers .= 'From:  Papr <afzalhp22@gmail.com>' . "\r\n";
    $headers .= 'cc: afzalhp22@gmail.com' . "\r\n";
    $headers .= 'bcc: afzalhp22@gmail.com' . "\r\n";
    mail($to, $subject, $_message, $headers, '-f afzalhp22@gmail.com');
