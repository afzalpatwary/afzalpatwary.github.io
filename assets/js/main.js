(function ($) {
    ...
    //         navText: ['<img src="https://i.postimg.cc/kGzn2CtZ/left.png" class="img-fluid carousel-img" alt="" />', '<img src="https://i.postimg.cc/Z53qyWHL/arrow-right-1.png" class="img-fluid carousel-img" alt="" />'],
    //         responsive: {
    //             0: {
    //                 items: 1
    //             },
    ...
    $(function () {
        if (window.matchMedia("(max-width: 991px)").matches) {
            ...
            $('.btn-loadMore').on('click', function (e) {
                e.preventDefault();
                $('.loadMoreParent .loadMoreItem:hidden').slice(0, 2).show();
            ...
            $('.btn-loadMore').on('click', function (e) {
                e.preventDefault();
                $('.loadMoreParent .loadMoreItem:hidden').slice(0, 3).show();
    ...
    $(function () {
        if (window.matchMedia("(max-width: 991px)").matches) {
            $('.loadMoreParent2 .loadMoreItem2').slice(0, 6).show();
            $('.btn-loadMore2').on('click', function (e) {
                e.preventDefault();
                $('.loadMoreParent2 .loadMoreItem2:hidden').slice(0, 2).show();
                if ($('.loadMoreParent2 .loadMoreItem2:hidden').length < 1) {
                    $(this).addClass('disabled').css('cursor', 'no-drop')
                } else {
                    $(this).removeClass('disabled').css('cursor', 'default')
                }
            ...
            $('.btn-loadMore2').on('click', function (e) {
                e.preventDefault();
                $('.loadMoreParent2 .loadMoreItem2:hidden').slice(0, 3).show();
                console.log($('.loadMoreParent2 .loadMoreItem2:hidden').length)
                if ($('.loadMoreParent2 .loadMoreItem2:hidden').length < 1) {
                    $(this).addClass('disabled').css('cursor', 'no-drop')
                } else {
                    $(this).removeClass('disabled').css('cursor', 'default')
    ...
    $(function () {
        if (window.matchMedia("(max-width: 991px)").matches) {
            $('.loadMoreParent1 .loadMoreItem1').slice(0, 6).show();
            $('.btn-loadMore1').on('click', function (e) {
                e.preventDefault();
                $('.loadMoreParent1 .loadMoreItem1:hidden').slice(0, 2).show();
                if ($('.loadMoreParent1 .loadMoreItem1:hidden').length < 1) {
                    $(this).addClass('disabled').css('cursor', 'no-drop')
                } else {
                    $(this).removeClass('disabled').css('cursor', 'default')
                }
            ...
            $('.btn-loadMore1').on('click', function (e) {
                e.preventDefault();
                $('.loadMoreParent1 .loadMoreItem1:hidden').slice(0, 3).show();
                console.log($('.loadMoreParent1 .loadMoreItem1:hidden').length)
                if ($('.loadMoreParent1 .loadMoreItem1:hidden').length < 1) {
                    $(this).addClass('disabled').css('cursor', 'no-drop')
                } else {
                    $(this).removeClass('disabled').css('cursor', 'default')
